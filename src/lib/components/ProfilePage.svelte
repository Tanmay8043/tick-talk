...
<div class="max-w-4xl max-h-[80vh] overflow-y-auto mx-auto">

    <div class="px-3 py-2 relative">
      
        <div class="flex flex-col gap-1 text-center">
            <a class="block mx-auto bg-center bg-no-repeat bg-cover w-20 h-20 rounded-full border border-gray-400 shadow-lg h-40 w-40" href="" style="background-image: url('https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg')"></a>
            <p class="font-serif font-semibold">Marina Davinchi</p>
            <span class="text-sm text-gray-400">New York, NY - Los Angeles, CA</span>
        </div>

        <button class="md:hidden absolute right-4 top-8 cursor" on:click={()=>(selected.set("Settings"))} title="Edit Profile">
