...
<div transition:fade={{ duration: 200, easing: quintOut }} class="fixed z-20 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-center px-6 justify-center min-h-screen pt-4 pb-20 text-center  sm:p-0">
      ...
      <div in:fly={{y:200, duration: 200, easing:quintOut}} out:fly={{y:200, duration: 200, easing:quintOut}} class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle max-w-lg w-full p-6">
